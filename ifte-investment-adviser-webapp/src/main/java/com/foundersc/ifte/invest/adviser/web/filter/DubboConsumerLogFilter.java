...
public class DubboConsumerLogFilter implements Filter {
    ...
    static {
        ignorePrintResultMap.put("com.foundersc.ifte.invest.adviser.dubbo.api.service.KycRemoteService", Sets.newHashSet("queryTestjour"));
        ignorePrintResultMap.put("com.foundersc.ifc.portfolio.t2.service.v2.BopService", Sets.newHashSet("downloadEpaperTemplate"));
    }
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            if (!Thread.currentThread().getName().startsWith("DubboMonitorSendTimer")) {
    ...
    private boolean shouldIgnoreResult(String interfaceName, String methodName) {
        return ignorePrintResultMap.containsKey(interfaceName) && ignorePrintResultMap.get(interfaceName).contains(methodName);
    }
}
