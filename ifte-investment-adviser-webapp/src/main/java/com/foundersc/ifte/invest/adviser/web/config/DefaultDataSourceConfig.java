...
public class DefaultDataSourceConfig {
    @Autowired
    private NodeKeyProperties nodeKeyProperties;

    @Primary
    @Bean
    public DataSource dataSource() {
        log.info("DataSource NodeKey {}", nodeKeyProperties.getOracle());
        FZDataSource fzDataSource = new FZDataSource();
        fzDataSource.setNodeKey(nodeKeyProperties.getOracle());
        return fzDataSource;
    }
