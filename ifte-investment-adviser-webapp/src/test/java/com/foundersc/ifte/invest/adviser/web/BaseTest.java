...
public class BaseTest {
    //61615497
    private static final String CLIENT_ID = "2030041610";//注：资金账号和客户号可能不一样
    private static final String FUND_ACCOUNT = "2030041610"; //资金账户
    private static final String INVESTOR_ACCOUNT = "2030041610"; //投顾账户
